...
- 결제
```
 http :8088/결제 id="id" customerid="customerid" foodid="foodid" option="option" address="address" status="status" 
```
- 주문
```
...
- 배달
```
 http :8088/배달 id="id" orderid="orderid" address="address" status="status" 
```
